...
export default function EditOrder({params: {id}}: {params: {id: string}}) {
  ...
  return (
    <Layout
      breadcrumb={
        <Breadcrumb
          items={[{label: 'Orders', link: '/orders'}, {label: 'Edit order'}]}
        />
      }
    >
      <form
      ...
      >
        <section className={styles.createOrderForm}>
          <div className={styles.createFormHeader}>
            <h1 className={styles.createOrderFormTitle}>Edit order #123456</h1>
        ...
        <section className={styles.createOrderSummary}>
          ...
          <div className={styles.actions}>
            ...
            <button className={styles.deleteOrderButton}>Delete order</button>
          </div>
        </section>
      </form>
    </Layout>
